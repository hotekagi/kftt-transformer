...
def get_vocab(
    ...
    return build_vocab_from_iterator(_yield_token(path_to_corpus), specials=specials, max_tokens=vocab_size)
...
def text_to_tensor(text: str, vocab: Vocab, max_len: int, eos: bool = True, bos: bool = True) -> torch.Tensor:
